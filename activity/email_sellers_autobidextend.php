<?php
function send_email_updating_sellers($email_arr){
    ...
    foreach ($email_to_arr as $email_to) {
        ...
        $subject = "Auto-extend end-date for ".$productName;
        $body = "Hey ".$email_to['sellerName']."!\nYour product ".$productName." just reached its set end date & time without any bids being made on it, so we auto-extended ".$bidPrice." on ".$productName;
